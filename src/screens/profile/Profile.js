...
const Profile = ({navigation}) => {
  ...
  const weightIcon = () => {
    return <Icon size={18} name="weight" color="#3743ab"></Icon>;
  };
  const userIcon = () => {
    return <Icon size={18} name="user" color="#3743ab"></Icon>;
  };
  const phoneIcon = () => {
    return <Icon size={18} name="phone-alt" color="#3743ab"></Icon>;
  };
  return (
                      ...
                      {({
                        ...
                        <View style={styles.inputContainer}>
                          ...
                          testID="weightID"
                            ...
                            value={values.Weight}
                            left={<TextInput.Icon name={weightIcon} />}
                          />
                          {errors.Weight && (
                            <Text style={styles.errorText}>
                              {errors.Weight}
